    ...
    <div className="p-3 space-y-3">
      <div className="card">
        <div className="card-header py-1.5">
          <span className="text-xs">Emergency Routing</span>
        </div>
        <div className="p-2 text-[10px] text-gray-400 leading-relaxed">
          All route planning is treated as emergency response. Flooded roads are avoided automatically, and the system moves to the next safe alternative if a selected route becomes blocked.
        </div>
      </div>
      ...
      >
        {planning ? "Computing 3 routes..." : "Compute 3 Optimal Routes"}
      </button>
      ...
      {plannedRoutes.length > 0 && (
        <div className="space-y-2">
          ...
          <p className="text-[10px] text-gray-500 leading-relaxed">
            The best route is highlighted automatically. When a flood is plotted on the active path, the vehicle reroutes from its live position in real time.
          </p>
          ...
          <div className="p-2 space-y-2">
            {!simulating ? (
              ...
              <>
                ...
                >
                  {pickMode === "flood" ? "Click map to place flood..." : "Plot Flood on Route"}
                </button>
